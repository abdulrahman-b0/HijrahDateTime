...
class SimpleHijrahDateSerializationTest {

    private lateinit var hijrahDate: SimpleHijrahDate
    private lateinit var objectMapper: ObjectMapper

    @BeforeEach
    fun setUp() {
        hijrahDate = SimpleHijrahDate.of(1165, 10, 1)
    ...
    fun deserialize() {
        ...
        val deserialized = objectMapper.readValue(value, SimpleHijrahDate::class.java)
    ...
    private data class TestClass(
        @JsonSerialize(using = SimpleHijrahDateSerialization.Serializer::class)
        @JsonDeserialize(using = SimpleHijrahDateSerialization.Deserializer::class)
        val hijrahDate: SimpleHijrahDate
    )
