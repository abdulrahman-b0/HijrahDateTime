...
import com.abdulrahman_b.hijrah_datetime.serialization.kotlinx.HijrahDateToStringSerializer
...
class HijrahDateSerializerTest {
    ...
    fun deserializeWithKotlinx() {
        ...
        var deserialized = Json.decodeFromString(HijrahDateToStringSerializer, jsonElement)
    ...
    fun serializeWithKotlinx() {
        var serialized = Json.encodeToString(HijrahDateToStringSerializer, hijrahDate)
