...
internal class OffsetHijrahDateTimeValidationTest {
    ...
    fun setUp() {
        ...
        val hijrahDateTime = OffsetHijrahDateTime.now()
        mockkObject(OffsetHijrahDateTime.Companion)

        every { OffsetHijrahDateTime.now(capture(capturedClock)) } answers { hijrahDateTime }
    ...
    fun testPastDate() {
        val now = OffsetHijrahDateTime.now(Clock.systemUTC())
    ...
    private data class PastDateHolder (@field:Past val date: OffsetHijrahDateTime?)
    private data class FutureDateHolder (@field:Future val date: OffsetHijrahDateTime?)
    private data class PastOrPresentDateHolder (@field:PastOrPresent val date: OffsetHijrahDateTime?)
    private data class FutureOrPresentDateHolder (@field:FutureOrPresent val date: OffsetHijrahDateTime?)
