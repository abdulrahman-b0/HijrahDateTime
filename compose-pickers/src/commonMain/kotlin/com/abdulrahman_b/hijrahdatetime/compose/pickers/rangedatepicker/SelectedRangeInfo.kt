...
internal class SelectedRangeInfo(
    ...
    companion object {
        ...
        fun calculateRangeInfo(
            ...
            val displayedMonthStart = displayedMonth.onDay(1)
            val displayedMonthEnd = displayedMonth.lastDay
            val displayedMonthNumberOfDays = displayedMonth.numberOfDays
            ...
            val startGridItemOffset =
                if (firstIsSelectionStart) {
                    displayedMonthDaysFromStartOfWeekToFirstOfMonth + startDate.day - 1
                } else {
                    displayedMonthDaysFromStartOfWeekToFirstOfMonth
                }
            val endGridItemOffset =
                if (lastIsSelectionEnd) {
                    displayedMonthDaysFromStartOfWeekToFirstOfMonth + endDate.day - 1
                } else {
