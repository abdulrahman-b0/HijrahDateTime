...
import com.abdulrahman_b.hijrahdatetime.pickers.yearContainerColor
import com.abdulrahman_b.hijrahdatetime.pickers.yearContentColor
import com.abdulrahman_b.hijrahdatetime.resources.Res
import com.abdulrahman_b.hijrahdatetime.resources.date_picker_navigate_to_year_description
import com.abdulrahman_b.hijrahdatetime.resources.date_picker_switch_to_day_selection
import com.abdulrahman_b.hijrahdatetime.resources.date_picker_switch_to_year_selection
...
internal fun YearPickerMenuButton(
    ...
    TextButton(
        ...
        Icon(
            ...
            contentDescription =
                if (expanded) {
                    stringResource(Res.string.date_picker_switch_to_day_selection)
                } else {
                    stringResource(Res.string.date_picker_switch_to_year_selection)
                },
        ...
        LazyVerticalGrid(
            ...
            items(yearRange.count()) {
                ...
                Year(
                    ...
                    description =
                        stringResource(Res.string.date_picker_navigate_to_year_description, localizedYear),
                    colors = colors
                ) {
                    Text(
                        text = localizedYear,
