package com.abdulrahman_b.hijrahdatetime.pickers.components
...
import com.abdulrahman_b.hijrahdatetime.pickers.calculateDaysFromStartOfWeekToFirstOfMonth
...
import com.abdulrahman_b.hijrahdatetime.pickers.rangedatepicker.SelectedRangeInfo
import com.abdulrahman_b.hijrahdatetime.pickers.rangedatepicker.drawRangeBackground
            ...
            Row(
                ...
                repeat(DAYS_IN_WEEK) { j ->
                    ...
                    if (
                        ...
                        cellIndex >=
                        (daysFromStartOfWeekToFirstOfMonth + displayedMonth.numberOfDays)
                    ) {
                        // Empty cell
                        Spacer(
                            modifier =
                        ...
                        val inRange =
                            if (rangeSelectionInfo != null && startDate != null && endDate != null) {
                                remember(rangeSelectionInfo, date, startDate, endDate) {
                                    mutableStateOf(date in startDate..endDate)
                                }.value
                            } else {
                                false
                            }
    ...
    snapshotFlow { pagerState.currentPage }
        .collect {
            onDisplayedMonthChange(
                calculateYearMonthFromPage(it, yearRange)
            )
        }
}
