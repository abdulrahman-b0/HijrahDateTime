...
import com.abdulrahman_b.hijrahdatetime.resources.date_range_input_title
import com.abdulrahman_b.hijrahdatetime.resources.date_range_picker_end_headline
import com.abdulrahman_b.hijrahdatetime.resources.date_range_picker_start_headline
import com.abdulrahman_b.hijrahdatetime.resources.date_range_picker_title
...
object HijrahDateRangePickerDefaults {
    ...
    fun DateRangePickerTitle(displayMode: DisplayMode, modifier: Modifier = Modifier) {
        when (displayMode) {
            DisplayMode.Picker ->
                Text(stringResource(Res.string.date_range_picker_title), modifier = modifier)

            DisplayMode.Input ->
                Text((stringResource(Res.string.date_range_input_title)), modifier = modifier)
        }
    }
    ...
    fun HijriDateRangePickerHeadline(
        ...
        val startDateText = stringResource(Res.string.date_range_picker_start_headline)
        val endDateText = stringResource(Res.string.date_range_picker_end_headline)
