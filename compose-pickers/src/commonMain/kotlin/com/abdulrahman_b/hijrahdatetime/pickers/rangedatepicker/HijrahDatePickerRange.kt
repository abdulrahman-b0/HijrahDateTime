package com.abdulrahman_b.hijrahdatetime.pickers.rangedatepicker/*
...
import com.abdulrahman_b.hijrahdatetime.pickers.calculateYearMonthFromPage
import com.abdulrahman_b.hijrahdatetime.pickers.components.DatePickerAnimatedContent
import com.abdulrahman_b.hijrahdatetime.pickers.components.Month
import com.abdulrahman_b.hijrahdatetime.pickers.components.WeekDays
import com.abdulrahman_b.hijrahdatetime.pickers.components.updateDisplayedMonth
import com.abdulrahman_b.hijrahdatetime.pickers.datepicker.DAYS_IN_WEEK
import com.abdulrahman_b.hijrahdatetime.pickers.datepicker.DateEntryContainer
import com.abdulrahman_b.hijrahdatetime.pickers.datepicker.DatePickerHorizontalPadding
import com.abdulrahman_b.hijrahdatetime.pickers.datepicker.DatePickerModeTogglePadding
import com.abdulrahman_b.hijrahdatetime.pickers.datepicker.DisplayModeToggleButton
import com.abdulrahman_b.hijrahdatetime.pickers.datepicker.HijrahDatePickerDefaults
import com.abdulrahman_b.hijrahdatetime.pickers.datepicker.RecommendedSizeForAccessibility
...
import com.abdulrahman_b.hijrahdatetime.resources.date_range_picker_scroll_to_next_month
import com.abdulrahman_b.hijrahdatetime.resources.date_range_picker_scroll_to_previous_month
...
private fun VerticalMonthsList(
    ...
    ProvideTextStyle(DatePickerModalTokens.DateLabelTextFont) {
        ...
        val scrollToPreviousMonthLabel =
            stringResource(Res.string.date_range_picker_scroll_to_previous_month)
        val scrollToNextMonthLabel =
            stringResource(Res.string.date_range_picker_scroll_to_next_month)
        ...
        VerticalPager(
            ...
            val displayedMonth = remember(currentPage, yearRange) {
                calculateYearMonthFromPage(currentPage, yearRange)
            }
