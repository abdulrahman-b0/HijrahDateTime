...
import com.abdulrahman_b.hijrahdatetime.pickers.HijrahDatePickerFormatter
import com.abdulrahman_b.hijrahdatetime.pickers.HijrahSelectableDates
import com.abdulrahman_b.hijrahdatetime.pickers.LocalDayOfWeekTextStyle
import com.abdulrahman_b.hijrahdatetime.pickers.LocalFirstDayOfWeek
import com.abdulrahman_b.hijrahdatetime.pickers.LocalPickerDecimalStyle
import com.abdulrahman_b.hijrahdatetime.pickers.LocalPickerFormatter
import com.abdulrahman_b.hijrahdatetime.pickers.LocalPickerLocale
import com.abdulrahman_b.hijrahdatetime.pickers.LocalTimeZone
import com.abdulrahman_b.hijrahdatetime.pickers.ProvideContentColorTextStyle
import com.abdulrahman_b.hijrahdatetime.pickers.calculatePageFromYearMonth
import com.abdulrahman_b.hijrahdatetime.pickers.calculateTotalPages
import com.abdulrahman_b.hijrahdatetime.pickers.components.DatePickerAnimatedContent
import com.abdulrahman_b.hijrahdatetime.pickers.components.HorizontalMonthsPager
import com.abdulrahman_b.hijrahdatetime.pickers.components.HorizontalMonthsPagerMulti
import com.abdulrahman_b.hijrahdatetime.pickers.components.MAX_CALENDAR_ROWS
import com.abdulrahman_b.hijrahdatetime.pickers.components.WeekDays
import com.abdulrahman_b.hijrahdatetime.pickers.components.YearPicker
import com.abdulrahman_b.hijrahdatetime.pickers.components.YearPickerMenuButton
import com.abdulrahman_b.hijrahdatetime.pickers.tokens.DatePickerModalTokens
import com.abdulrahman_b.hijrahdatetime.resources.Res
import com.abdulrahman_b.hijrahdatetime.resources.date_picker_switch_to_calendar_mode
import com.abdulrahman_b.hijrahdatetime.resources.date_picker_switch_to_input_mode
import com.abdulrahman_b.hijrahdatetime.resources.date_picker_switch_to_next_month
import com.abdulrahman_b.hijrahdatetime.resources.date_picker_switch_to_previous_month
import com.abdulrahman_b.hijrahdatetime.resources.date_picker_year_picker_pane_title
    ...
    if (displayMode == DisplayMode.Picker) {
        IconButton(onClick = { onDisplayModeChange(DisplayMode.Input) }, modifier = modifier) {
            Icon(
                ...
                contentDescription = stringResource(Res.string.date_picker_switch_to_input_mode)
            )
        }
    } else {
        IconButton(onClick = { onDisplayModeChange(DisplayMode.Picker) }, modifier = modifier) {
            Icon(
                ...
                contentDescription = stringResource(Res.string.date_picker_switch_to_calendar_mode)
            )
        }
    }
}
...
private fun SwitchableDateEntryContent(
    ...
    displayedMonth: HijrahYearMonth,
    displayMode: DisplayMode,
        ...
        when (mode) {
            DisplayMode.Picker -> {
                val monthPager = rememberPagerState(
                    initialPage = calculatePageFromYearMonth(displayedMonth, yearRange),
                ) {
                ...
                Column {
                    ...
                    Box {
                        ...
                        this@Column.AnimatedVisibility(
                            ...
                            val yearsPaneTitle =
                                stringResource(Res.string.date_picker_year_picker_pane_title)
                            Column(
                                ...
                                YearPicker(
                                    ...
                                    onYearSelected = { year ->
                                        coroutineScope.launch {
                                            val newMonth = HijrahYearMonth(year, displayedMonth.month.number)
                                            val newPage = calculatePageFromYearMonth(newMonth, yearRange)
    ...
    Column {
        ...
        Box {
            ...
            this@Column.AnimatedVisibility(
                ...
                val yearsPaneTitle = stringResource(Res.string.date_picker_year_picker_pane_title)
                    ...
                    YearPicker(
                        ...
                        onYearSelected = { year ->
                            ...
                            coroutineScope.launch {
                                ...
                                val withTargetYear = HijrahYearMonth(year, displayedMonth.month.number)
                                val page = calculatePageFromYearMonth(withTargetYear, yearRange)
                ...
                Row {
                    IconButton(onClick = onPreviousClicked, enabled = previousAvailable) {
                        Icon(
                            ...
                            contentDescription = stringResource(Res.string.date_picker_switch_to_previous_month)
                        )
                    }
                    IconButton(onClick = onNextClicked, enabled = nextAvailable) {
                        Icon(
                            Icons.AutoMirrored.Filled.KeyboardArrowRight,
                            contentDescription = stringResource(Res.string.date_picker_switch_to_next_month)
                        )
                    }
                }
            }
