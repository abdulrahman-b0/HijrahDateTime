...
class SimpleHijrahDateTest {

    val date = SimpleHijrahDate.of(700, 1, 30)
    ...
    @Test
    @DisplayName("SimpleHijrahDate is formatted properly")
    fun format() {
    ...
    @Test
    fun range() {
        assertEquals(ValueRange.of(SimpleHijrahDate.MIN_YEAR.toLong(), SimpleHijrahDate.MAX_YEAR.toLong()), date.range(ChronoField.YEAR))
    ...
    @Test
    fun equalsTest() {
        val date2 = SimpleHijrahDate.of(700, 1, 30)
        assertEquals(date, date2)
    }

    @Test
    fun compareTo() {
        var date2 = SimpleHijrahDate.of(700, 1, 30)
        assertEquals(0, date.compareTo(date2))

        date2 = SimpleHijrahDate.of(700, 2, 1)
        assertTrue(date < date2)

        date2 = SimpleHijrahDate.of(700, 1, 1)
        assertTrue(date > date2)
