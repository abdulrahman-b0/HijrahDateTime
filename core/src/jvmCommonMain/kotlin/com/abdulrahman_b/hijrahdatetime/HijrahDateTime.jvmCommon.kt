...
actual class HijrahDateTime(
    ...
    actual constructor(
        ...
        try {
            JavaHijrahDate.of(year, month, day).atTime(LocalTime.of(hour, minute, second, nanosecond))
        } catch (e: DateTimeException) {
            throw IllegalArgumentException("Invalid datetime: $year-$month-$day $hour:$minute:$second", e)
        })
