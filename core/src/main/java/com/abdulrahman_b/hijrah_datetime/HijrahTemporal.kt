 ...
 *
 * @param T the implementation type of the date-time object, which is a subclass of [HijrahTemporal], all operations in this class return this type.
 */
sealed class HijrahTemporal<T : HijrahTemporal<T>>(
     ...
     *
     * The [temporal] type is the same as the provided [Temporal] in the constructor of [HijrahTemporal], you can safely cast it to the required type.
     *
